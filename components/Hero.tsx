      ...
      <div className="container mx-auto px-4 py-8 md:py-10 lg:py-12">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-6 md:gap-8 lg:gap-4 items-center">
            {/* Text Content */}
            <div className="space-y-6 z-10 flex flex-col items-center md:items-start w-full">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight text-center md:text-left w-full">
                <span className="gradient-text">Edwar Alexander</span>
                <br />
                <span className="text-matrix-green">Benito Basante</span>
              </h1>
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-matrix-green text-center md:text-left w-full">
                {currentContent.role}
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-theme-secondary max-w-2xl leading-relaxed text-justify w-full">
                {currentContent.description}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-4 items-center justify-center md:justify-start w-full">
                <a
                  href="#portfolio"
